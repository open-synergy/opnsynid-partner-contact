...
class ResPartner(models.Model):
    ...
    def _compute_sale_risk_adjustment(self):
        for partner in self:
            ...
            partner.risk_sale_order_adjustment = risk_sale_order_adjustment

    @api.multi
    @api.depends(
        "sale_order_ids",
        "sale_order_ids.invoice_pending_amount",
    ...
    def _compute_risk_sale_order(self):
        ...
        for partner in self:
            partner.risk_sale_order += partner.risk_sale_order_adjustment
