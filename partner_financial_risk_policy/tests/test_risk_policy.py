...
class TestRiskPolicy(TransactionCase):
    ...
    def test_partner_failed_total_risk_limit(self):
        ...
        self.assertEqual(cm.exception.value, tools.ustr(err_msg))
        self.assertEqual(self.partner.total_risk_limit_policy, 100.00)
        self.assertEqual(self.partner.invoice_draft_limit_policy, 100.00)
        self.assertEqual(self.partner.invoice_open_limit_policy, 100.00)
        self.assertEqual(self.partner.invoice_unpaid_limit_policy, 100.00)
        self.assertEqual(self.partner.account_amount_limit_policy, 100.00)
    ...
    def test_partner_failed_invoice_draft_limit(self):
        ...
        self.assertEqual(cm.exception.value, tools.ustr(err_msg))
        self.assertEqual(self.partner.total_risk_limit_policy, 200.00)
        self.assertEqual(self.partner.invoice_draft_limit_policy, 100.00)
        self.assertEqual(self.partner.invoice_open_limit_policy, 100.00)
        self.assertEqual(self.partner.invoice_unpaid_limit_policy, 100.00)
        self.assertEqual(self.partner.account_amount_limit_policy, 100.00)
    ...
    def test_partner_failed_invoice_open_limit(self):
        ...
        self.assertEqual(cm.exception.value, tools.ustr(err_msg))
        self.assertEqual(self.partner.total_risk_limit_policy, 200.00)
        self.assertEqual(self.partner.invoice_draft_limit_policy, 200.00)
        self.assertEqual(self.partner.invoice_open_limit_policy, 100.00)
        self.assertEqual(self.partner.invoice_unpaid_limit_policy, 100.00)
        self.assertEqual(self.partner.account_amount_limit_policy, 100.00)
    ...
    def test_partner_failed_invoice_unpaid_limit(self):
        ...
        self.assertEqual(self.partner.total_risk_limit_policy, 200.00)
        self.assertEqual(self.partner.invoice_draft_limit_policy, 200.00)
        self.assertEqual(self.partner.invoice_open_limit_policy, 200.00)
        self.assertEqual(self.partner.invoice_unpaid_limit_policy, 100.00)
        self.assertEqual(self.partner.account_amount_limit_policy, 100.00)
    ...
    def test_partner_failed_account_amount_limit(self):
        ...
        self.assertEqual(self.partner.invoice_draft_limit_policy, 200.00)
        self.assertEqual(self.partner.invoice_open_limit_policy, 200.00)
        self.assertEqual(self.partner.invoice_unpaid_limit_policy, 200.00)
        self.assertEqual(self.partner.account_amount_limit_policy, 100.00)
    ...
    def test_partner_success_all_limit(self):
        ...
        self.assertEqual(self.partner.invoice_open_limit_policy, 200.00)
        self.assertEqual(self.partner.invoice_unpaid_limit_policy, 200.00)
        self.assertEqual(self.partner.account_amount_limit_policy, 200.00)
